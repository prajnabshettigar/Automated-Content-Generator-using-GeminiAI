...
const cards = [
  {
    ...
    description:
      "Here innovation drives our solutions. We specialize in transforming complex AI technology into user-friendly tools for content generation, ensuring our clients stay ahead in the digital content race.",
    icon: PhoneIcon,
  },
  {
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:mx-0">
          <h2 className="text-4xl font-bold tracking-tight text-white sm:text-6xl">
            Automated AI Content Generator - Redefining Content Creation
          </h2>
          <p className="mt-6 text-lg leading-8 text-gray-300">
            Automated AI Content Generator is revolutionizing the way content is
            created. Our cutting-edge AI technology automates and enhances
            content generation, enabling creators to produce high-quality,
            engaging material with ease.
          </p>
        </div>

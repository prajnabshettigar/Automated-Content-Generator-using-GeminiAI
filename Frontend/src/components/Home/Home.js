...
import ai from "../../Images/pngtree-artificial-intelligence-connecting-mind-image_15627095.jpg";
          ...
          <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
            ...
            <div className="mx-auto max-w-2xl text-center">
              ...
              <p className="mx-auto mt-6 text-lg leading-8 text-gray-300">
                This is a content generator that uses AI to generate content for
                you. It is a tool that helps you generate content for your blog,
